...
namespace Migrations.Migrations
{
    ...
    [Migration("20240416083553_seedPaymentTypeTbl")]
    partial class seedPaymentTypeTbl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.BlogsAggregate.Blog", b =>
                {
                    ...
                    b.Property<string>("PaymentSubscriptionPlanId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.LookupsAggregate.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.SubscriptionAggregate.BillingHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.SubscriptionAggregate.Subscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.BlogsAggregate.Blog", b =>
                {
                    b.HasOne("Domain.SubscriptionAggregate.Subscription", "Subscription")
                        .WithMany("blogs")
            ...
            modelBuilder.Entity("Domain.SubscriptionAggregate.BillingHistory", b =>
                {
                    ...
                    b.HasOne("Domain.LookupsAggregate.PaymentType", "PaymentType")
                        .WithMany()
