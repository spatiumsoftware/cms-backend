...
namespace Infrastructure.UOW
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public ISeoAndOptimizationRepository SeoAndOptimizationRepository {  get; }
        ...
        public UnitOfWork(SpatiumDbContent spatiumDbContent)
        {
            ...
            SubscriptionRepository = new SubscriptionRepository(spatiumDbContent);
            SeoAndOptimizationRepository = new SeoAndOptimizationRepository(spatiumDbContent);
            #endregion
        }
