...
namespace Infrastructure.Database.Repository
{
    public class BlogRepository : RepositoryBase, IBlogRepository
    {
        ...
        public async Task TryDeleteBlogsAsync(Blog blog)
        {
            SpatiumDbContent.Blogs.Remove(blog);
        }

        public async Task TryDeletePostsAsync(Post post)
        {
            SpatiumDbContent.TableOfContents.RemoveRange(post.TableOfContents);
            SpatiumDbContent.Shares.RemoveRange(post.Shares);
            SpatiumDbContent.Comments.RemoveRange(post.Comments);
            SpatiumDbContent.Posts.Remove(post);
        }
