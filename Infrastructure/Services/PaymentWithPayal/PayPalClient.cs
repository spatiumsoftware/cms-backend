...
{ 
    public sealed class PaypalClient
    {
        ...
        public async Task<CreateProductResponse> CreateProduct(CreateProductRequest request)
        {
            ...
            var respons = await httpResponse.Content.ReadFromJsonAsync<CreateProductResponse>();
            return respons;
        }
        ...
        public async Task<CreateOrderResponse> CreateOrder(string value, string currency, string reference)
        {
            ...
            var request = new CreateOrderRequest
            {
                ...
                { 
                    ...
                    cancel_url = "http://localhost:4200/cms/setting"
                }
        ...
        public async Task<CaptureOrderResponse> History()
        {
            var auth = await Authenticate();
            ...
            var httpResponse = await httpClient.GetAsync($"{BaseUrl}//v1/reporting/transactions?start_date=2014-07-01T00:00:00-0700&end_date=2014-07-30T23:59:59-0700&transaction_id=5TY05013RG002845M&fields=all&page_size=100&page=1");
