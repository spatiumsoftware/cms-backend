...
namespace Infrastructure.Extensions
{
    public static class UserManagerExtensions
    {
        ...
        public static  async Task<List<ApplicationUser>> GetUsersCount(this UserManager<ApplicationUser> userManager, int blogId)
        {
            var allUsers =await  userManager.Users.Where(x => x.BlogId == blogId).ToListAsync();
            return   allUsers;
        }
